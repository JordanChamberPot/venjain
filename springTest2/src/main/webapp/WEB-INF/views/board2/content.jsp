...
<body>
	<table border=1	>
		...
		<tbody class="class02">
			...
			<tr>
				<th>내용: </th>
				<td><textarea cols="50" rows="20" readonly="readonly"><c:out value="${bdto.content}" /></textarea></td>

			</tr>
			<tr>
				<th>첨부파일: </th>
				<td><c:out value="${bdto.attachNm}" />
				</td>
			</tr>
			<tr>
				<th>작성자: </th>
				<td><a href='mailto:<c:out value="${bdto.email}"/>'>
					<c:out value="${bdto.writer}" /></a></td>
			</tr>
			<tr align="center">
				<td colspan=2>
	...
	<form action="" name="parentForm" method="post">
		...
		<input type= "hidden" name="passwd" value="${bdto.passwd}" />
